...
const PERIODS: Period[] = [
  ...
  },
  {
    ...
    people: [
      ...
      },
      {
        ...
        branches: [
          { name: "Taamar", relation: "minia", desc: "Sünnitas Juudale Peretsi ja Serahi.", ref: { label: "1Ms 38" } },
        ],
      },
      ...
      { name: "Nahson", category: "other", desc: "Juuda hõimu vürst kõrbeteel.", ref: { label: "4Ms 2:3; Mt 1:4" } },
      ...
      { name: "Iisai", category: "other", desc: "Taaveti isa, Betlemast.", ref: { slug: "1-saamuel", label: "1Sm 16:1; 17:12" } },
    ],
  },
  {
  ...
  },
  {
    ...
    people: [
      ...
      { name: "Ahas", category: "king", desc: "Kummardas ebajumalaid.", ref: { label: "2Kn 16" } },
      ...
      { name: "Aamon", category: "king", desc: "Valitses kaks aastat.", ref: { label: "2Kn 21:19–26" } },
  ...
  },
  {
    ...
    people: [
      ...
      { name: "Serubbaabel", category: "other", desc: "Juhatas esimese rahva Babüloniast tagasi, ehitas teise templi.", ref: { slug: "esra", label: "Esr 2 – 6; Hg 1 – 2" } },
      { name: "Abihuud", category: "other", desc: "Serubbaabeli poeg.", ref: { label: "Mt 1:13" } },
      { name: "Eljakim", category: "other", desc: "Abihuudi poeg.", ref: { label: "Mt 1:13" } },
      { name: "Asur", category: "other", desc: "Eljakimi poeg.", ref: { label: "Mt 1:13" } },
      { name: "Saadok", category: "other", desc: "Asuri poeg.", ref: { label: "Mt 1:14" } },
      { name: "Aahim", category: "other", desc: "Saadoki poeg.", ref: { label: "Mt 1:14" } },
      { name: "Elihuud", category: "other", desc: "Aahimi poeg.", ref: { label: "Mt 1:14" } },
      { name: "Eleasar", category: "other", desc: "Elihuudi poeg.", ref: { label: "Mt 1:15" } },
