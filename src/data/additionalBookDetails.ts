...
export const additionalBookDetails: Record<string, BookDetail> = {
  ...
  "ilmutus": {
    ...
    additionalFacts: ["Piibli viimane raamat", "Sisaldab arvu 7 üle 50 korra", "Seitse pitserit, pasunat ja vihakaussi", "Lubab õnnistust selle lugejatele (Ilm 1:3)"],
    breakdowns: [
      ...
      { title: "Kohtuotsused (ptk 6-19)", description: "Pitserid, pasunad, vihakausid" },
