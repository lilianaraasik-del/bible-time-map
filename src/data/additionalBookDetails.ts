...
export const additionalBookDetails: Record<string, BookDetail> = {
  ...
  "3-johannese-kiri": {
    ...
    period: "u 90-95 pKr",
    category: "Üldkirjad",
    overview: "Lühike isiklik kiri Gaajusele, kes näitas külalislahkust rändavatele kuulutajatele. Vastupidiselt Diotrefesele, kes keeldus külalisi vastu võtmast ja ajas teisi koguduset välja. Kiri õpetab toetama tõe edasikuulutamist.",
    authorFacts: ["Adresseeritud Gaajusele", "Kõige isiklikum Johannese kiri", "Mainib kolme inimest: Gaajus, Diotrefes, Demeetrios", "Käsitleb koguduste konflikti"],
    additionalFacts: ["Ainult 14 salmi", "Diotrefes 'tahab olla esimene'", "Käsitleb külalislahkust", "Demeetrios saab head tunnistust"],
    breakdowns: [
      { title: "Tervitused (v 1-4)", description: "Mul ei ole suuremat rõõmu" },
      { title: "Gaajuse külalislahkus (v 5-8)", description: "Sa teed ustavalt" },
      { title: "Diotrefese probleem (v 9-10)", description: "Tema, kes tahab olla esimene" },
      { title: "Demeetriose tunnistus (v 11-12)", description: "Demeetriosele kõik annavad tunnistust" },
