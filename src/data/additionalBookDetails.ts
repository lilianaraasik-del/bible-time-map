...
export const additionalBookDetails: Record<string, BookDetail> = {
  "kohtumoistjad": {
    ...
    authorFacts: ["Prohvet Saamuel elas üleminekuaegadel kohtumõistjatest kuningateni", "Oli prohvet ja preester", "Võidis kuningaks Sauli ja Taaveti", "Juhtis Iisraeli viimase kohtumõistjana"],
    additionalFacts: ["Raamatus on 12 kohtumõistjat", "Simson oli füüsiliselt tugevaim kohtumõistja", "Deebora oli ainus naissoost kohtumõistja", "Giideon võitis 300 mehega 135 000 vaenlast"],
    breakdowns: [
      ...
      { title: "Giideon (ptk 6-8)", description: "300 meest võidavad midjanlasi" },
  ...
  "iiob": {
    ...
    authorFacts: ["Elas tõenäoliselt patriarhide ajal", "Oli idamaa rikkaim mees", "Kaotas kümme last ühel päeval", "Sai lõpuks tagasi kahekordse õnnistuse"],
    ...
    breakdowns: [
      ...
      { title: "Eliihu kõned (ptk 32-37)", description: "Noor Eliihu pakub uut perspektiivi" },
  ...
  "jesaja": {
    ...
    additionalFacts: ["Raamatus on 66 peatükki – nagu Piiblis raamatuid", "Esimesed 39 ptk käsitlevad kohut, viimased 27 lohutust", "Sisaldab Messia ennustusi: Js 7:14, Js 9:6, Js 53", "Kannatava sulase laul (Js 53) ennustab Jeesuse risti"],
    breakdowns: [
  ...
  "taaniel": {
    ...
    category: "Prohvetid",
    overview: "Taaniel on lugu noormehest, kes hoidis usku ka võõral maas. Babüloonias keeldus ta keisri toidust, palus avalikult Jumalat ja sai tarkust unenägude tõlgendamiseks. Lõvide augus jäi ta puutumata. Tema raamat sisaldab võimsaid prohvetlikke nägemusi maailma impeeriumitest ja Messia tulekust.",
    authorFacts: ["Vangistati noorukina Babülooniasse", "Teenis nelja kuninga ajal (Nebukadnetsar–Küüros)", "Sai tarkuse otse Jumalalt", "Elas üle 80 aasta vanaks"],
    ...
    breakdowns: [
      ...
      { title: "Tuline ahi (ptk 3)", description: "Kolm sõpra päästetakse ahjust" },
  ...
  "joona": {
    ...
    category: "Prohvetid",
    overview: "Joona on lugu prohvetist, kes põgenes Jumala eest. Talle anti ülesanne minna Niinivesse, kuid ta läks vastassuunas. Tormi ja kala kõhus veedetud aja järel kuulas ta lõpuks Jumalat. Niinive kahetses ja päästeti. Raamat õpetab Jumala armu kõigi rahvaste vastu.",
    ...
    additionalFacts: ["Jeesus võrdles end Joonaga", "Kala kõhust välja viskamine ennustas Kristuse ülestõusmist", "Niinive oli Assüüria pealinn", "Üle 120 000 elanikku Niinives"],
    breakdowns: [
      ...
      { title: "Niinive kahetseb (ptk 3)", description: "Linn pöördub patust" },
  ...
  "nahum": {
    ...
    category: "Prohvetid",
    overview: "Nahum kuulutas Niinive hävingut – linn, mis Joona ajal kahetses, oli pöördunud tagasi pahedele. Raamat näitab, et Jumala kannatlikkusel on piir. Assüüria oli julm impeerium, mis oli põhja-kuningriigi hävitanud. Nahum lubab: nende julm valitsus saab otsa.",
    authorFacts: ["Pärit Elkosest", "Eluajast on vähe teada", "Kuulutas Juudas", "Nimi tähendab 'lohutus'"],
    additionalFacts: ["Niinive hävitati 612 eKr (täpselt nagu Nahum ennustas)", "Raamat on suurepärane luule", "Kontrast Joona raamatuga", "Lohutus juutidele Assüüria langemise kohta"],
    breakdowns: [
      { title: "Jumala iseloom (ptk 1:1-8)", description: "Aeglane vihastama, kuid kindel kohtumõistja" },
      { title: "Niinive hukk (ptk 1:9-15)", description: "Su põlil on ots" },
      { title: "Niinive piiramine (ptk 2)", description: "Vaenlased valmistuvad rünnakuks" },
      { title: "Niinive langemine (ptk 3:1-11)", description: "Veriste linnade ots" },
  ...
  "haggai": {
    ...
    period: "u 520 eKr",
    category: "Prohvetid",
    overview: "Haggai oli üks esimesi prohveteid pärast Babüloonia vangipõlve. Rahvas oli tagasi tulnud, kuid templi taastamine oli seiskunud 16 aastaks. Haggai kuulutas: 'Kas on aeg, et te ise elate vooderdatud kodades, aga see koda on rusudes?' Rahvas asus tööle.",
    authorFacts: ["Üks esimesi 'tagasipöördumise' prohveteid", "Töötas koos Sakarjaga", "Kuulutas kuberner Serubbaabelile", "Tema kuulutus elustas templi taastamise"],
    ...
    breakdowns: [
      ...
      { title: "Õnnistus algab täna (ptk 2:10-19)", description: "Sellest päevast peale ma õnnistan" },
      { title: "Serubbaabeli lubadus (ptk 2:20-23)", description: "Sind ma võtan kui pitseri" },
    ],
    piibeeUrl: "https://piibel.ee",
  },
  "sakarja": {
  ...
  "tiitusele": {
    ...
    authorFacts: ["Üks 'pastorikirjadest'", "Tiitus oli Kreeka taustaga", "Pauluse kaaslane mitmel reisil", "Jäeti Kreetale tööle"],
    ...
    breakdowns: [
      { title: "Vanemate valimine (ptk 1)", description: "Sa pidid Kreetale jääma korralduse pärast" },
      ...
      { title: "Head teod (ptk 3:8-11)", description: "Need, kes on Jumalasse uskunud" },
  ...
  "fileemonile": {
    ...
    period: "u 60-62 pKr",
    category: "Pauluse kirjad",
    overview: "Kõige isiklikum Pauluse kiri – ainult 25 salmi. Oneesimos oli ori, kes oli põgenenud oma isandalt Fileemonilt. Roomas kohtus ta Paulusega ja sai usklikuks. Paulus saadab ta tagasi Fileemoni juurde palvega: võta ta vastu mitte enam orjana, vaid armsa vennana.",
    authorFacts: ["Kirjutatud Rooma vangistusest", "Fileemon oli rikas usklik Kolossas", "Oneesimos oli tema põgenenud ori", "Saadeti koos Koloslastele kirjaga"],
    additionalFacts: ["Lühim Pauluse kiri (üks ptk)", "Käsitleb põgenenud orja", "Näitab kristluse mõju orjasüsteemile", "Oneesimos sai hiljem Efesose piiskopiks"],
    breakdowns: [
      { title: "Tervitus ja kiitus (v 1-7)", description: "Sinu armastusest olen kuulnud" },
      { title: "Palve Oneesimose eest (v 8-16)", description: "Võta ta vastu kui mind ennast" },
  ...
  "heebrealastele": {
    ...
    additionalFacts: ["Sisaldab usu kangelaste 'autahvlit' (Hb 11)", "Õpetab Kristust kui ülempreestrit Melkisedeki korras", "Hoiatab usust ärataganemise eest"],
    breakdowns: [
  ...
  "jaakobus": {
    name: "Jakobuse kiri",
    author: "Jakobus (Issanda vend)",
    period: "u 45-50 pKr",
    category: "Üldkirjad",
    overview: "Jakobus oli Jeesuse vend ja Jeruusalemma koguduse juht. Tema kiri on praktiline: usk ilma tegudeta on surnud. Ta käsitleb katsumusi, partsiaalsust, keele ohtlikkust, palvetamise jõudu. Stiililt sarnane Jeesuse Mäejutlusele.",
  ...
  "juudas": {
    ...
    period: "u 65-80 pKr",
    category: "Üldkirjad",
    overview: "Juudas oli Jeesuse vend, Jakobuse poolvend. Tema lühike kiri on tugev hoiatus valeõpetajate vastu, kes 'on hiilinud koguduset sisse'. Ta toob näiteid Vanast Testamendist – Soodom, Korah, Bileam – ja kutsub usklikke 'usu eest võitlema'.",
    authorFacts: ["Jeesuse poolvend", "Jakobuse vend", "Pole eluajal olnud usklik", "Üks lühim Uue Testamendi raamat"],
